...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL'),'sqlite:///data.db') #To tell the SQLALCHEMY where to find the data.db ,is goind to read the file.
